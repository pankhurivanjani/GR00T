...
class IRLSinglePandaGripperDataConfig1(BaseDataConfig):
    video_keys = [
        "video.ego_view",
        # "video.second_view"   # two cameras
    ]
...
class IRLSinglePandaGripperDataConfig2(BaseDataConfig):
    video_keys = [
        # "video.ego_view",
        "video.second_view"   # two cameras
    ]
...
DATA_CONFIG_MAP = {
    ...
    "irl_panda_1": IRLSinglePandaGripperDataConfig1(),
    "irl_panda_2": IRLSinglePandaGripperDataConfig2(),
